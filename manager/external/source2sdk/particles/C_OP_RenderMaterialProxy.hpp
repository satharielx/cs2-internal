...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nMaterialControlPoint; // 0x220            
            // metadata: MPropertyFriendlyName "proxy type"
            source2sdk::particles::MaterialProxyType_t m_nProxyType; // 0x224            
            ...
            char m_MaterialVars[0x18]; // 0x228            
            ...
            char m_hOverrideMaterial[0x8]; // 0x240            
            // metadata: MPropertyFriendlyName "material override enable"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flMaterialOverrideEnabled; // 0x248            
            // metadata: MPropertyFriendlyName "model tint"
            source2sdk::particleslib::CParticleCollectionVecInput m_vecColorScale; // 0x3b8            
            // metadata: MPropertyFriendlyName "model alpha"
            source2sdk::particleslib::CPerParticleFloatInput m_flAlpha; // 0xa70            
            // metadata: MPropertyFriendlyName "model tint blend type"
            source2sdk::particles::ParticleColorBlendType_t m_nColorBlendType; // 0xbe0            
            uint8_t _pad0be4[0x1c];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_RenderMaterialProxy because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_RenderMaterialProxy) == 0xc00);
    };
};
