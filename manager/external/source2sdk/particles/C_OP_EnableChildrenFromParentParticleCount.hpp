...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nFirstChild; // 0x1dc            
            // metadata: MPropertyFriendlyName "max # of children to enable (-1 for max particle count)"
            source2sdk::particleslib::CParticleCollectionFloatInput m_nNumChildrenToEnable; // 0x1e0            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_EnableChildrenFromParentParticleCount) == 0x358);
    };
};
