...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldOutputAnim; // 0x1e0            
            ...
            source2sdk::particles::ParticleSetMethod_t m_nSetMethod; // 0x1f4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_InitialSequenceFromModel because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_InitialSequenceFromModel) == 0x1f8);
    };
};
