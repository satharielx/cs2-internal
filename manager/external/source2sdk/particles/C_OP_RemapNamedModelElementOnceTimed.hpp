...
namespace source2sdk
{
    namespace particles
    {
        ...
        #pragma pack(push, 1)
        class C_OP_RemapNamedModelElementOnceTimed : public source2sdk::particles::CParticleFunctionOperator
        {
        public:
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RemapNamedModelElementOnceTimed) == 0x230);
    };
};
