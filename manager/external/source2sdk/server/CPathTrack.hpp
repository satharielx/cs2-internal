...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            // metadata: MClassPtr
            source2sdk::server::CPathTrack* m_pnext; // 0x4a8            
            // metadata: MClassPtr
            source2sdk::server::CPathTrack* m_pprevious; // 0x4b0            
            // metadata: MClassPtr
            source2sdk::server::CPathTrack* m_paltpath; // 0x4b8            
            float m_flRadius; // 0x4c0            
            float m_length; // 0x4c4            
            CUtlSymbolLarge m_altName; // 0x4c8            
            // metadata: MNotSaved
            std::int32_t m_nIterVal; // 0x4d0            
            source2sdk::server::TrackOrientationType_t m_eOrientationType; // 0x4d4            
            source2sdk::entity2::CEntityIOOutput m_OnPass; // 0x4d8            
        ...
        static_assert(sizeof(source2sdk::server::CPathTrack) == 0x4f0);
    };
};
