...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::CRandomNumberGeneratorParameters m_randomnessParameters; // 0x1f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_OffsetVectorToVector because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_OffsetVectorToVector) == 0x200);
    };
};
