...
#include <cstddef>
#include <cstdint>
#include "source2sdk/client/CDestructiblePart_DamageLevel.hpp"
...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDestructiblePart, m_nOtherHitgroupsToDestroyWhenFullyDestructed) == 0x10);
