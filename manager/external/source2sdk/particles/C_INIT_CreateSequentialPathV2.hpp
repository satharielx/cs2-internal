...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_fMaxDistance; // 0x1d8            
            // metadata: MPropertyFriendlyName "particles to map from start to end"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flNumToAssign; // 0x348            
            ...
            source2sdk::particles::CPathParameters m_PathParams; // 0x4c0            
            uint8_t _pad0500[0x10];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_CreateSequentialPathV2 because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_CreateSequentialPathV2) == 0x510);
    };
};
