...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::fogparams_t, dirPrimary) == 0x8);
        static_assert(offsetof(source2sdk::server::fogparams_t, colorPrimary) == 0x14);
        static_assert(offsetof(source2sdk::server::fogparams_t, colorSecondary) == 0x18);
        static_assert(offsetof(source2sdk::server::fogparams_t, colorPrimaryLerpTo) == 0x1c);
        static_assert(offsetof(source2sdk::server::fogparams_t, colorSecondaryLerpTo) == 0x20);
        static_assert(offsetof(source2sdk::server::fogparams_t, start) == 0x24);
        static_assert(offsetof(source2sdk::server::fogparams_t, end) == 0x28);
        static_assert(offsetof(source2sdk::server::fogparams_t, farz) == 0x2c);
        static_assert(offsetof(source2sdk::server::fogparams_t, maxdensity) == 0x30);
        static_assert(offsetof(source2sdk::server::fogparams_t, exponent) == 0x34);
        static_assert(offsetof(source2sdk::server::fogparams_t, HDRColorScale) == 0x38);
        static_assert(offsetof(source2sdk::server::fogparams_t, skyboxFogFactor) == 0x3c);
        static_assert(offsetof(source2sdk::server::fogparams_t, skyboxFogFactorLerpTo) == 0x40);
        static_assert(offsetof(source2sdk::server::fogparams_t, startLerpTo) == 0x44);
        static_assert(offsetof(source2sdk::server::fogparams_t, endLerpTo) == 0x48);
        static_assert(offsetof(source2sdk::server::fogparams_t, maxdensityLerpTo) == 0x4c);
        static_assert(offsetof(source2sdk::server::fogparams_t, lerptime) == 0x50);
        static_assert(offsetof(source2sdk::server::fogparams_t, duration) == 0x54);
        static_assert(offsetof(source2sdk::server::fogparams_t, blendtobackground) == 0x58);
        static_assert(offsetof(source2sdk::server::fogparams_t, scattering) == 0x5c);
