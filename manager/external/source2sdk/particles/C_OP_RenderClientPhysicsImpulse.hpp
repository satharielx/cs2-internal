...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_flRadius; // 0x220            
            // metadata: MPropertyFriendlyName "magnitude"
            source2sdk::particleslib::CPerParticleFloatInput m_flMagnitude; // 0x390            
            // metadata: MPropertyFriendlyName "filter explosion to single simulation id"
            std::int32_t m_nSimIdFilter; // 0x500            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RenderClientPhysicsImpulse) == 0x508);
    };
};
