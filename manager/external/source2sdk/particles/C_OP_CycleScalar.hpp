...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nDestField; // 0x1d0            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_CycleScalar) == 0x1f8);
    };
};
