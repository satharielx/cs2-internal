...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleSelection_t m_nParticleSelection; // 0x1d0            
            uint8_t _pad01d4[0x4]; // 0x1d4
            // metadata: MPropertyFriendlyName "particle number/offset"
            source2sdk::particleslib::CParticleCollectionFloatInput m_nParticleNumber; // 0x1d8            
            // metadata: MPropertyFriendlyName "Interpolation"
            source2sdk::particleslib::CPerParticleFloatInput m_flInterpolation; // 0x348            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_PinRopeSegmentParticleToParent because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_PinRopeSegmentParticleToParent) == 0x4b8);
    };
};
