...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionVecInput m_vecRotAxis; // 0x1d8            
            // metadata: MPropertyFriendlyName "rotation rate"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flRotRate; // 0x890            
            // metadata: MPropertyFriendlyName "control point"
            std::int32_t m_nCP; // 0xa00            
            // metadata: MPropertyFriendlyName "local space control point"
            std::int32_t m_nLocalCP; // 0xa04            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_SetControlPointRotation because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_SetControlPointRotation) == 0xa08);
    };
};
