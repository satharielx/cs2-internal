...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CEntityOutputTemplate<float,float> m_NearestEntityDistance;
            char m_NearestEntityDistance[0x20]; // 0x8a8            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerProximity) == 0x8c8);
    };
};
