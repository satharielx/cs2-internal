...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_flDragAtPlane; // 0x1d0            
            // metadata: MPropertyFriendlyName "falloff"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flFalloff; // 0x340            
            ...
            source2sdk::particleslib::CParticleCollectionVecInput m_vecPlaneNormal; // 0x4b8            
            // metadata: MPropertyFriendlyName "control point number"
            std::int32_t m_nControlPointNumber; // 0xb70            
            uint8_t _pad0b74[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_DragRelativeToPlane because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_DragRelativeToPlane) == 0xb78);
    };
};
