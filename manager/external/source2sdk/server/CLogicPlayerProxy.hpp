...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_PlayerHasAmmo; // 0x4a8            
            source2sdk::entity2::CEntityIOOutput m_PlayerHasNoAmmo; // 0x4c0            
            source2sdk::entity2::CEntityIOOutput m_PlayerDied; // 0x4d8            
            ...
            // CEntityOutputTemplate<std::int32_t,std::int32_t> m_RequestedPlayerHealth;
            char m_RequestedPlayerHealth[0x20]; // 0x4f0            
        ...
        static_assert(sizeof(source2sdk::server::CLogicPlayerProxy) == 0x518);
    };
};
