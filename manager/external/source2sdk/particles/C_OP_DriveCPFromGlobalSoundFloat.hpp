...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nOutputControlPoint; // 0x1d8            
            // metadata: MPropertyFriendlyName "output field"
            // metadata: MPropertyAttributeChoiceName "vector_component"
            std::int32_t m_nOutputField; // 0x1dc            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_DriveCPFromGlobalSoundFloat) == 0x210);
    };
};
