...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            Color m_DefaultHSVColor; // 0x1e4            
            uint8_t _pad01e8[0x10];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_HSVShiftToCP because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_HSVShiftToCP) == 0x1f8);
    };
};
