...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nVolumeDepth; // 0x628            
            // metadata: MNetworkEnable
            float m_fFirstVolumeSliceThickness; // 0x62c            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimX; // 0x630            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimY; // 0x634            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimZ; // 0x638            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartAnisoTime; // 0x658            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartScatterTime; // 0x65c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartDrawDistanceTime; // 0x660            
            // metadata: MNetworkEnable
            ...
            char m_hFogIndirectTexture[0x8]; // 0x680            
            // metadata: MNetworkEnable
            std::int32_t m_nForceRefreshCount; // 0x688            
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::client::C_EnvVolumetricFogController) == 0x6b8);
    };
};
