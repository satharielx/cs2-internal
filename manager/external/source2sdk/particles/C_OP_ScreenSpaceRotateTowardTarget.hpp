...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleRemapFloatInput m_flOutputRemap; // 0x888            
            // metadata: MPropertyFriendlyName "set value method"
            source2sdk::particles::ParticleSetMethod_t m_nSetMethod; // 0x9f8            
            uint8_t _pad09fc[0x4]; // 0x9fc
            // metadata: MPropertyFriendlyName "screen edge alignment distance"
            source2sdk::particleslib::CPerParticleFloatInput m_flScreenEdgeAlignmentDistance; // 0xa00            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_ScreenSpaceRotateTowardTarget because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_ScreenSpaceRotateTowardTarget) == 0xb70);
    };
};
