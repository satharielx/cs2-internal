...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_flSpeedMin; // 0x1d8            
            // metadata: MPropertyFriendlyName "maximum speed"
            source2sdk::particleslib::CPerParticleFloatInput m_flSpeedMax; // 0x348            
            // metadata: MPropertyFriendlyName "end spread"
            source2sdk::particleslib::CPerParticleFloatInput m_flEndSpread; // 0x4b8            
            // metadata: MPropertyFriendlyName "start offset"
            source2sdk::particleslib::CPerParticleFloatInput m_flStartOffset; // 0x628            
            // metadata: MPropertyFriendlyName "end offset"
            source2sdk::particleslib::CPerParticleFloatInput m_flEndOffset; // 0x798            
            // metadata: MPropertyFriendlyName "end control point"
            std::int32_t m_nEndControlPointNumber; // 0x908            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_MoveBetweenPoints) == 0x910);
    };
};
