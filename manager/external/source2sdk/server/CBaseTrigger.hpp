...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnStartTouch; // 0x7b0            
            source2sdk::entity2::CEntityIOOutput m_OnStartTouchAll; // 0x7c8            
            source2sdk::entity2::CEntityIOOutput m_OnEndTouch; // 0x7e0            
            source2sdk::entity2::CEntityIOOutput m_OnEndTouchAll; // 0x7f8            
            source2sdk::entity2::CEntityIOOutput m_OnTouching; // 0x810            
            source2sdk::entity2::CEntityIOOutput m_OnTouchingEachEntity; // 0x828            
            source2sdk::entity2::CEntityIOOutput m_OnNotTouching; // 0x840            
            ...
            char m_hTouchingEntities[0x18]; // 0x858            
        ...
        static_assert(sizeof(source2sdk::server::CBaseTrigger) == 0x890);
    };
};
