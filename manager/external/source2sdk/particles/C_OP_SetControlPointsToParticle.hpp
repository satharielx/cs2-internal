...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nFirstSourcePoint; // 0x1dc            
            ...
            source2sdk::particles::ParticleOrientationSetMode_t m_nOrientationMode; // 0x1e4            
            // metadata: MPropertyFriendlyName "set parent"
            source2sdk::particles::ParticleParentSetMode_t m_nSetParent; // 0x1e8            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_SetControlPointsToParticle) == 0x1f0);
    };
};
