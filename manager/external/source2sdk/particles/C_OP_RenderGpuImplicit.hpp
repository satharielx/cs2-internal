...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::uint32_t m_nVertexCountKb; // 0x224            
            // metadata: MPropertyFriendlyName "(optional) index buffer size (k)"
            // metadata: MPropertyAttributeRange "0 2048"
            std::uint32_t m_nIndexCountKb; // 0x228            
            uint8_t _pad022c[0x4]; // 0x22c
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_fGridSize; // 0x230            
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_fRadiusScale; // 0x3a0            
            // metadata: MPropertyAttributeRange ".1 .95"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_fIsosurfaceThreshold; // 0x510            
