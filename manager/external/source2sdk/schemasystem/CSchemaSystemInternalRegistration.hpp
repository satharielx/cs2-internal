...
namespace source2sdk
{
    namespace schemasystem
    {
        ...
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_VectorAligned) == 0x20);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_Quaternion) == 0x30);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_QAngle) == 0x40);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_RotationVector) == 0x4c);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_RadianEuler) == 0x58);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_DegreeEuler) == 0x64);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_QuaternionStorage) == 0x70);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_matrix3x4_t) == 0x80);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_matrix3x4a_t) == 0xb0);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_Color) == 0xe0);
        static_assert(offsetof(source2sdk::schemasystem::CSchemaSystemInternalRegistration, m_Vector4D) == 0xe4);
