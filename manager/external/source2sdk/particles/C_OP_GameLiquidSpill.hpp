...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_flLiquidContentsField; // 0x220            
            // metadata: MPropertyFriendlyName "Expiration Time (seconds)"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flExpirationTime; // 0x390            
            // metadata: MPropertyFriendlyName "Attribute for Contribution Amount"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nAmountAttribute; // 0x500            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_GameLiquidSpill) == 0x508);
    };
};
