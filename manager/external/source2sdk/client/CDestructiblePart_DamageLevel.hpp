...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDestructiblePart_DamageLevel, m_sName) == 0x0);
        ...
        static_assert(sizeof(source2sdk::client::CDestructiblePart_DamageLevel) == 0x48);
    };
};
