...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nParticlesToMaintain; // 0x1d0            
            ...
            std::int32_t m_nSnapshotControlPoint; // 0x1d8            
            ...
            uint8_t _pad01e9[0x7]; // 0x1e9
            // metadata: MPropertyFriendlyName "total count scale"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flScale; // 0x1f0            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_DecayMaintainCount) == 0x368);
    };
};
