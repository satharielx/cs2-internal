...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::SetStatisticExpressionType_t m_nExpression; // 0x1d8            
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_flDecimalPlaces; // 0x1e0            
            // metadata: MPropertyFriendlyName "output control point"
            std::int32_t m_nOutControlPointNumber; // 0x350            
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nField; // 0x358            
            uint8_t _pad035c[0x4]; // 0x35c
            // metadata: MPropertyFriendlyName "output"
            source2sdk::particleslib::CParticleRemapFloatInput m_flOutputRemap; // 0x360            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_RemapAverageScalarValuetoCP because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_RemapAverageScalarValuetoCP) == 0x4d0);
    };
};
