...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            char m_pTextureNormal[0x8]; // 0x228            
            ...
            char m_pTextureMetalness[0x8]; // 0x230            
            ...
            char m_pTextureRoughness[0x8]; // 0x238            
            ...
            char m_pTextureSelfIllum[0x8]; // 0x240            
            ...
            char m_pTextureDetail[0x8]; // 0x248            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_RenderStatusEffectCitadel because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_RenderStatusEffectCitadel) == 0x250);
    };
};
