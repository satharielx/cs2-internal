...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_soundPlaying; // 0x4b0            
            uint8_t _pad04b4[0x14]; // 0x4b4
            ...
            // Datamap fields:
            // void m_soundTreads; // 0x4b8
            // void m_soundEngine; // 0x4c0
        ...
        static_assert(sizeof(source2sdk::server::CTankTrainAI) == 0x4e8);
    };
};
