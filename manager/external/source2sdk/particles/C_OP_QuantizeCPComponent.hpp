...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_flInputValue; // 0x1d8            
            // metadata: MPropertyFriendlyName "output control point"
            std::int32_t m_nCPOutput; // 0x348            
            // metadata: MPropertyFriendlyName "output component"
            // metadata: MPropertyAttributeChoiceName "vector_component"
            std::int32_t m_nOutVectorField; // 0x34c            
            // metadata: MPropertyFriendlyName "interval to snap to"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flQuantizeValue; // 0x350            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_QuantizeCPComponent because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_QuantizeCPComponent) == 0x4c0);
    };
};
