...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_flClusterRefireTime; // 0x1e0            
            // metadata: MPropertyFriendlyName "Within-Cluster Fire Count Before Cooldown"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flClusterSize; // 0x350            
            // metadata: MPropertyFriendlyName "Cluster Cooldown Time"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flClusterCooldown; // 0x4c0            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RepeatedTriggerChildGroup) == 0x638);
    };
};
