...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartTime; // 0x748            
            // metadata: MNetworkEnable
            source2sdk::client::EntityDisolveType_t m_nDissolveType; // 0x74c            
            // metadata: MNetworkEnable
            Vector m_vDissolverOrigin; // 0x750            
            // metadata: MNetworkEnable
            std::uint32_t m_nMagnitude; // 0x75c            
        ...
        static_assert(sizeof(source2sdk::server::CEntityDissolve) == 0x760);
    };
};
