...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_flInput; // 0x1d0            
            // metadata: MPropertyFriendlyName "rising edge value"
            source2sdk::particleslib::CPerParticleFloatInput m_flRisingEdge; // 0x340            
            // metadata: MPropertyFriendlyName "rising edge event type"
            source2sdk::particles::EventTypeSelection_t m_nRisingEventType; // 0x4b0            
            uint8_t _pad04b4[0x4]; // 0x4b4
            // metadata: MPropertyFriendlyName "falling edge value"
            source2sdk::particleslib::CPerParticleFloatInput m_flFallingEdge; // 0x4b8            
            // metadata: MPropertyFriendlyName "falling edge event type"
            source2sdk::particles::EventTypeSelection_t m_nFallingEventType; // 0x628            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_SetUserEvent) == 0x630);
    };
};
