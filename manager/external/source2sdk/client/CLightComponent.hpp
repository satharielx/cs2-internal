...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectLight; // 0x128            
            // metadata: MNetworkEnable
            ...
            uint8_t _pad01ac[0x44];
            
            // Datamap fields:
            // SHIM m_bRenderSpecular; // 0xc4
            // SHIM m_bCastShadows; // 0xb4
            // bool m_bAmbientOcclusionProxyOverride; // 0x1ac
            // float m_flAmbientOcclusionProxyStrength0; // 0x1c0
            // float m_flAmbientOcclusionProxyStrength1; // 0x1c4
            // float m_flAmbientOcclusionProxyStrength2; // 0x1c8
            // float m_flAmbientOcclusionProxyStrength3; // 0x1cc
            // float m_flAmbientOcclusionProxyAmbientStrength; // 0x1d0
            // float m_flAmbientOcclusionProxyConeAngle0; // 0x1d4
            // float m_flAmbientOcclusionProxyConeAngle1; // 0x1d8
            // float m_flAmbientOcclusionProxyConeAngle2; // 0x1dc
            // float m_flAmbientOcclusionProxyConeAngle3; // 0x1e0
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CLightComponent because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CLightComponent) == 0x1f0);
    };
};
