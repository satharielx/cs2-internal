...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::BrushSolidities_e m_iSolidity; // 0x730            
            std::int32_t m_iDisabled; // 0x734            
            bool m_bSolidBsp; // 0x738            
            uint8_t _pad0739[0x7]; // 0x739
        ...
        static_assert(sizeof(source2sdk::server::CFuncBrush) == 0x750);
    };
};
