...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::fogplayerparams_t, m_flOldStart) == 0x14);
        static_assert(offsetof(source2sdk::server::fogplayerparams_t, m_flOldEnd) == 0x18);
        static_assert(offsetof(source2sdk::server::fogplayerparams_t, m_flOldMaxDensity) == 0x1c);
        static_assert(offsetof(source2sdk::server::fogplayerparams_t, m_flOldHDRColorScale) == 0x20);
        static_assert(offsetof(source2sdk::server::fogplayerparams_t, m_flOldFarZ) == 0x24);
        static_assert(offsetof(source2sdk::server::fogplayerparams_t, m_NewColor) == 0x28);
        static_assert(offsetof(source2sdk::server::fogplayerparams_t, m_flNewStart) == 0x2c);
        static_assert(offsetof(source2sdk::server::fogplayerparams_t, m_flNewEnd) == 0x30);
