...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nCubemapSourceType; // 0x634            
            // metadata: MNetworkEnable
            ...
            char m_hFogCubemapTexture[0x8]; // 0x648            
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::client::C_EnvCubemapFog) == 0x658);
    };
};
