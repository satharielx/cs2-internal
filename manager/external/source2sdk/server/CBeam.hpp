...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_flFireTime; // 0x738            
            float m_flDamage; // 0x73c            
            // metadata: MNetworkEnable
            std::uint8_t m_nNumBeamEnts; // 0x740            
            ...
            char m_hBaseMaterial[0x8]; // 0x748            
            // metadata: MNetworkEnable
            ...
            char m_nHaloIndex[0x8]; // 0x750            
            // metadata: MNetworkEnable
            source2sdk::client::BeamType_t m_nBeamType; // 0x758            
            // metadata: MNetworkEnable
            std::uint32_t m_nBeamFlags; // 0x75c            
            // metadata: MNetworkEnable
            ...
            char m_hAttachEntity[0x28]; // 0x760            
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_nAttachIndex[10]; // 0x788            
            ...
            // metadata: MNetworkEnable
            source2sdk::client::BeamClipStyle_t m_nClipStyle; // 0x7b4            
            // metadata: MNetworkEnable
            ...
            char m_hEndEntity[0x4]; // 0x7c8            
            std::int32_t m_nDissolveType; // 0x7cc            
        ...
        static_assert(sizeof(source2sdk::server::CBeam) == 0x7d0);
    };
};
