...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_fSpeedMin; // 0x1e0            
            // metadata: MPropertyFriendlyName "random speed max"
            source2sdk::particleslib::CPerParticleFloatInput m_fSpeedMax; // 0x350            
            // metadata: MPropertyFriendlyName "speed in local coordinate system min"
            // metadata: MVectorIsCoordinate
            source2sdk::particleslib::CPerParticleVecInput m_LocalCoordinateSystemSpeedMin; // 0x4c0            
            // metadata: MPropertyFriendlyName "speed in local coordinate system max"
            // metadata: MVectorIsCoordinate
            source2sdk::particleslib::CPerParticleVecInput m_LocalCoordinateSystemSpeedMax; // 0xb78            
            // metadata: MPropertyFriendlyName "Ignore delta time (RenderTrails)"
            bool m_bIgnoreDT; // 0x1230            
            uint8_t _pad1231[0x3]; // 0x1231
            // metadata: MPropertyFriendlyName "Random number generator controls"
            source2sdk::particles::CRandomNumberGeneratorParameters m_randomnessParameters; // 0x1234            
            uint8_t _pad123c[0x4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_VelocityRandom because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_VelocityRandom) == 0x1240);
    };
};
