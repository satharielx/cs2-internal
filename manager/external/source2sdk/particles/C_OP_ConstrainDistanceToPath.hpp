...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::CPathParameters m_PathParameters; // 0x1e0            
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldScale; // 0x224            
            // metadata: MPropertyFriendlyName "manual time placement field"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nManualTField; // 0x228            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_ConstrainDistanceToPath) == 0x230);
    };
};
