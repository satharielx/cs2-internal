...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nForceInModel; // 0x2a0            
            ...
            uint8_t _pad02a6[0x2]; // 0x2a6
            // metadata: MPropertyFriendlyName "desired hitbox"
            source2sdk::particleslib::CParticleCollectionFloatInput m_nDesiredHitbox; // 0x2a8            
            // metadata: MPropertyFriendlyName "Control Point Providing Hitbox index"
            std::int32_t m_nHitboxValueFromControlPointIndex; // 0x418            
            uint8_t _pad041c[0x4]; // 0x41c
            // metadata: MPropertyFriendlyName "hitbox scale"
            source2sdk::particleslib::CParticleCollectionVecInput m_vecHitBoxScale; // 0x420            
            ...
            source2sdk::particleslib::CParticleCollectionVecInput m_vecDirectionBias; // 0xae0            
            ...
            uint8_t _pad121b[0x5]; // 0x121b
            // metadata: MPropertyFriendlyName "hitbox shell thickness"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flShellSize; // 0x1220            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_CreateOnModel because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_CreateOnModel) == 0x1390);
    };
};
