...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            uint8_t _pad00b0[0xc9]; // 0xb0
            // metadata: MNetworkEnable
            bool m_bClientClothCreationSuppressed; // 0x179            
            uint8_t _pad017a[0xa6]; // 0x17a
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "skeletonMeshGroupMaskChanged"
            std::uint64_t m_MeshGroupMask; // 0x220            
            uint8_t _pad0228[0x48]; // 0x228
            // metadata: MNetworkEnable
            ...
            char m_nBodyGroupChoices[0x18]; // 0x270            
            uint8_t _pad0288[0x32]; // 0x288
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "skeletonMotionTypeChanged"
            std::int8_t m_nIdealMotionType; // 0x2ba            
            std::int8_t m_nForceLOD; // 0x2bb            
            std::int8_t m_nClothUpdateFlags; // 0x2bc            
            uint8_t _pad02bd[0x13];
        ...
        static_assert(offsetof(source2sdk::client::CModelState, m_bClientClothCreationSuppressed) == 0x179);
        static_assert(offsetof(source2sdk::client::CModelState, m_MeshGroupMask) == 0x220);
        static_assert(offsetof(source2sdk::client::CModelState, m_nBodyGroupChoices) == 0x270);
        static_assert(offsetof(source2sdk::client::CModelState, m_nIdealMotionType) == 0x2ba);
        static_assert(offsetof(source2sdk::client::CModelState, m_nForceLOD) == 0x2bb);
        static_assert(offsetof(source2sdk::client::CModelState, m_nClothUpdateFlags) == 0x2bc);
        
        static_assert(sizeof(source2sdk::client::CModelState) == 0x2d0);
    };
};
