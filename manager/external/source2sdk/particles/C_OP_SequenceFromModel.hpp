...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldOutputAnim; // 0x1d8            
            ...
            source2sdk::particles::ParticleSetMethod_t m_nSetMethod; // 0x1ec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_SequenceFromModel because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_SequenceFromModel) == 0x1f0);
    };
};
