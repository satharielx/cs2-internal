...
namespace source2sdk
{
    namespace modellib
    {
        ...
        public:
            ...
            // CUtlVector<CStrongHandle<source2sdk::resourcesystem::InfoForResourceTypeCRenderMesh>> m_refMeshes;
            ...
            // CUtlVector<std::uint64_t> m_refMeshGroupMasks;
            ...
            // CUtlVector<std::uint64_t> m_refPhysGroupMasks;
            ...
            // CUtlVector<std::uint8_t> m_refLODGroupMasks;
            ...
            // CUtlVector<CStrongHandle<source2sdk::resourcesystem::InfoForResourceTypeCPhysAggregateData>> m_refPhysicsData;
            ...
            // CUtlVector<CStrongHandle<source2sdk::resourcesystem::InfoForResourceTypeCPhysAggregateData>> m_refPhysicsHitboxData;
            ...
            // CUtlVector<CStrongHandle<source2sdk::resourcesystem::InfoForResourceTypeCAnimationGroup>> m_refAnimGroups;
            ...
            // CUtlVector<CStrongHandle<source2sdk::resourcesystem::InfoForResourceTypeCSequenceGroupData>> m_refSequenceGroups;
            ...
            // CUtlVector<source2sdk::modellib::MaterialGroup_t> m_materialGroups;
            char m_materialGroups[0x18]; // 0x168            
            std::uint64_t m_nDefaultMeshGroupMask; // 0x180            
            source2sdk::modellib::ModelSkeletonData_t m_modelSkeleton; // 0x188            
            ...
            // CUtlVector<std::int16_t> m_remappingTable;
            ...
            // CUtlVector<std::uint16_t> m_remappingTableStarts;
            ...
            // CUtlVector<source2sdk::modellib::ModelBoneFlexDriver_t> m_boneFlexDrivers;
            char m_boneFlexDrivers[0x18]; // 0x260            
            source2sdk::modellib::CModelConfigList* m_pModelConfigList; // 0x278            
            ...
            // CUtlVector<CStrongHandle<source2sdk::resourcesystem::InfoForResourceTypeCModel>> m_refAnimIncludeModels;
        ...
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_name) == 0x0);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_modelInfo) == 0x8);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_ExtParts) == 0x60);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_refMeshes) == 0x78);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_refMeshGroupMasks) == 0x90);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_refPhysGroupMasks) == 0xa8);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_refLODGroupMasks) == 0xc0);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_lodGroupSwitchDistances) == 0xd8);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_refPhysicsData) == 0xf0);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_refPhysicsHitboxData) == 0x108);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_refAnimGroups) == 0x120);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_refSequenceGroups) == 0x138);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_meshGroups) == 0x150);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_materialGroups) == 0x168);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_nDefaultMeshGroupMask) == 0x180);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_modelSkeleton) == 0x188);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_remappingTable) == 0x230);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_remappingTableStarts) == 0x248);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_boneFlexDrivers) == 0x260);
        static_assert(offsetof(source2sdk::modellib::PermModelData_t, m_pModelConfigList) == 0x278);
