...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleVariableRef m_variableReference; // 0x1d8            
            ...
            source2sdk::particleslib::CParticleCollectionVecInput m_vecInput; // 0x2a8            
            // metadata: MPropertyFriendlyName "Value"
            // metadata: MPropertySuppressExpr "m_variableReference.m_variableType != PVAL_FLOAT"
            source2sdk::particleslib::CParticleCollectionFloatInput m_floatInput; // 0x960            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_SetVariable because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_SetVariable) == 0xad0);
    };
};
