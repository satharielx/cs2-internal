...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnPlayerInZone; // 0x738            
            source2sdk::entity2::CEntityIOOutput m_OnPlayerOutZone; // 0x750            
            ...
            // CEntityOutputTemplate<std::int32_t,std::int32_t> m_PlayersInCount;
            char m_PlayersInCount[0x20]; // 0x768            
            ...
            // CEntityOutputTemplate<std::int32_t,std::int32_t> m_PlayersOutCount;
            char m_PlayersOutCount[0x20]; // 0x788            
        ...
        static_assert(sizeof(source2sdk::server::CGamePlayerZone) == 0x7a8);
    };
};
