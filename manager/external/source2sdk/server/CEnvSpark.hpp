...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nMagnitude; // 0x4ac            
            std::int32_t m_nTrailLength; // 0x4b0            
            std::int32_t m_nType; // 0x4b4            
            source2sdk::entity2::CEntityIOOutput m_OnSpark; // 0x4b8            
        ...
        static_assert(sizeof(source2sdk::server::CEnvSpark) == 0x4d0);
    };
};
