...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::PointOrientGoalDirectionType_t m_nGoalDirection; // 0x618            
            source2sdk::client::PointOrientConstraint_t m_nConstraint; // 0x61c            
            float m_flMaxTurnRate; // 0x620            
            source2sdk::entity2::GameTime_t m_flLastGameTime; // 0x624            
        ...
        static_assert(sizeof(source2sdk::client::CPointOrient) == 0x628);
    };
};
