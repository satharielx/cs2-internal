...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleOmni2LightTypeChoiceList_t m_nLightType; // 0x220            
            uint8_t _pad0224[0x4]; // 0x224
            // metadata: MPropertyFriendlyName "Color Blend"
            source2sdk::particleslib::CParticleCollectionVecInput m_vColorBlend; // 0x228            
            ...
            bool m_bFog; // 0xbc9            
            uint8_t _pad0bca[0x6]; // 0xbca
            // metadata: MPropertyFriendlyName "Fog Scale"
            // metadata: MPropertySuppressExpr "!m_bFog"
            source2sdk::particleslib::CPerParticleFloatInput m_flFogScale; // 0xbd0            
            // metadata: MPropertyFriendlyName "Light Radius"
            source2sdk::particleslib::CPerParticleFloatInput m_flLuminaireRadius; // 0xd40            
            // metadata: MPropertyFriendlyName "Skirt"
            source2sdk::particleslib::CPerParticleFloatInput m_flSkirt; // 0xeb0            
            // metadata: MPropertyFriendlyName "Range"
            source2sdk::particleslib::CPerParticleFloatInput m_flRange; // 0x1020            
            // metadata: MPropertyFriendlyName "Inner Cone Angle"
            source2sdk::particleslib::CPerParticleFloatInput m_flInnerConeAngle; // 0x1190            
            // metadata: MPropertyFriendlyName "Outer Cone Angle"
            source2sdk::particleslib::CPerParticleFloatInput m_flOuterConeAngle; // 0x1300            
