...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            char m_hModel[0x8]; // 0x228            
            // metadata: MPropertyFriendlyName "input model override"
            source2sdk::particleslib::CParticleModelInput m_modelInput; // 0x230            
            // metadata: MPropertyStartGroup "Rendering"
            // metadata: MPropertyFriendlyName "size cull scale"
            source2sdk::particleslib::CParticleCollectionFloatInput m_fSizeCullScale; // 0x290            
            ...
            uint8_t _pad0403[0x5]; // 0x403
            // metadata: MPropertyFriendlyName "render filter"
            source2sdk::particleslib::CPerParticleFloatInput m_fDrawFilter; // 0x408            
            // metadata: MPropertyFriendlyName "angular velocity attribute (improves motion blur)"
            // metadata: MPropertyAttributeChoiceName "particlefield_vector"
            source2sdk::particles::ParticleAttributeIndex_t m_nAngularVelocityField; // 0x578            
            uint8_t _pad057c[0x14];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_RenderSimpleModelCollection because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_RenderSimpleModelCollection) == 0x590);
    };
};
