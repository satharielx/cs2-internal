...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_flDistance; // 0x1d8            
            // metadata: MPropertyFriendlyName "component scale"
            source2sdk::particleslib::CParticleCollectionVecInput m_vecScale; // 0x348            
            // metadata: MPropertyFriendlyName "distance squared output attribute"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nDistSqrAttr; // 0xa00            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_MovementLoopInsideSphere) == 0xa08);
    };
};
