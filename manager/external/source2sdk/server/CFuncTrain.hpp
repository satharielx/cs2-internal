...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hCurrentTarget[0x4]; // 0x7d8            
            ...
            char m_hEnemy[0x4]; // 0x7e0            
            float m_flBlockDamage; // 0x7e4            
            source2sdk::entity2::GameTime_t m_flNextBlockTime; // 0x7e8            
        ...
        static_assert(sizeof(source2sdk::server::CFuncTrain) == 0x7f8);
    };
};
