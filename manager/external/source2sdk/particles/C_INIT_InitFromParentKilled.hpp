...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nAttributeToCopy; // 0x1d8            
            // metadata: MPropertyFriendlyName "event type"
            source2sdk::particles::EventTypeSelection_t m_nEventType; // 0x1dc            
            uint8_t _pad01e0[0x80];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_InitFromParentKilled because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_InitFromParentKilled) == 0x260);
    };
};
