...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            // metadata: MPropertySuppressExpr "m_bRandom == true"
            source2sdk::particleslib::CParticleCollectionFloatInput m_nSnapShotIncrement; // 0x1f8            
            // metadata: MPropertyFriendlyName "Manual Snapshot Index"
            // metadata: MPropertySuppressExpr "m_bRandom == true"
            source2sdk::particleslib::CPerParticleFloatInput m_nManualSnapshotIndex; // 0x368            
            // metadata: MPropertyFriendlyName "random seed"
            // metadata: MPropertySuppressExpr "m_bRandom == false"
            std::int32_t m_nRandomSeed; // 0x4d8            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_InitFromCPSnapshot) == 0x4e0);
    };
};
