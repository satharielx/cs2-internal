...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hMeasureTarget[0x4]; // 0x4c0            
            ...
            char m_hMeasureReference[0x4]; // 0x4c4            
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x4c8            
            ...
            char m_hTargetReference[0x4]; // 0x4cc            
            float m_flScale; // 0x4d0            
            std::int32_t m_nMeasureType; // 0x4d4            
        ...
        static_assert(sizeof(source2sdk::server::CLogicMeasureMovement) == 0x4d8);
    };
};
