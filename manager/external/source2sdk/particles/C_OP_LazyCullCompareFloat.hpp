...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_flComparsion1; // 0x1d0            
            // metadata: MPropertyFriendlyName "Comparison Value 2"
            source2sdk::particleslib::CPerParticleFloatInput m_flComparsion2; // 0x340            
            // metadata: MPropertyFriendlyName "Cull Lifetime"
            source2sdk::particleslib::CPerParticleFloatInput m_flCullTime; // 0x4b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_LazyCullCompareFloat because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_LazyCullCompareFloat) == 0x620);
    };
};
