...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hReference[0x4]; // 0x4c8            
            source2sdk::server::EntFinderMethod_t m_FindMethod; // 0x4cc            
            source2sdk::entity2::CEntityIOOutput m_OnFoundEntity; // 0x4d0            
        ...
        static_assert(sizeof(source2sdk::server::CPointEntityFinder) == 0x4e8);
    };
};
