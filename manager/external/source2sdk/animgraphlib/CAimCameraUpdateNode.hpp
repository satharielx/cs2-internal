...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        public:
            ...
            source2sdk::animgraphlib::CAnimParamHandle m_hParameterPelvisOffset; // 0x74            
            source2sdk::animgraphlib::CAnimParamHandle m_hParameterCameraOnly; // 0x76            
            source2sdk::animgraphlib::CAnimParamHandle m_hParameterWeaponDepenetrationDistance; // 0x78            
            source2sdk::animgraphlib::CAnimParamHandle m_hParameterWeaponDepenetrationDelta; // 0x7a            
            source2sdk::animgraphlib::CAnimParamHandle m_hParameterCameraClearanceDistance; // 0x7c            
