...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_flParticlesPerOrbit; // 0x240            
            // metadata: MPropertyFriendlyName "initial radius"
            source2sdk::particleslib::CPerParticleFloatInput m_flInitialRadius; // 0x3b0            
            // metadata: MPropertyFriendlyName "thickness"
            source2sdk::particleslib::CPerParticleFloatInput m_flThickness; // 0x520            
            // metadata: MPropertyFriendlyName "min initial speed"
            source2sdk::particleslib::CPerParticleFloatInput m_flInitialSpeedMin; // 0x690            
            // metadata: MPropertyFriendlyName "max initial speed"
            source2sdk::particleslib::CPerParticleFloatInput m_flInitialSpeedMax; // 0x800            
            // metadata: MPropertyFriendlyName "roll"
            source2sdk::particleslib::CPerParticleFloatInput m_flRoll; // 0x970            
            // metadata: MPropertyFriendlyName "pitch"
            source2sdk::particleslib::CPerParticleFloatInput m_flPitch; // 0xae0            
            // metadata: MPropertyFriendlyName "yaw"
            source2sdk::particleslib::CPerParticleFloatInput m_flYaw; // 0xc50            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_RingWave) == 0xdc8);
    };
};
