...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nScalarFieldForTextureCoordinate; // 0x3288            
            ...
            uint8_t _pad3292[0x2]; // 0x3292
            // metadata: MPropertyFriendlyName "attribute to use for rope segment id"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nSplitField; // 0x3294            
            ...
            source2sdk::particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x329c            
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nVectorFieldForOrientation; // 0x32a0            
