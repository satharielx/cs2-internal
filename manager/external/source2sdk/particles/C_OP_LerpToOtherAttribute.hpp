...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldInputFrom; // 0x340            
            // metadata: MPropertyFriendlyName "input attribute to"
            // metadata: MPropertyAttributeChoiceName "particlefield"
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldInput; // 0x344            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_LerpToOtherAttribute) == 0x370);
    };
};
