...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CEffectData, m_vAngles) == 0x2c);
        static_assert(offsetof(source2sdk::server::CEffectData, m_hEntity) == 0x38);
        static_assert(offsetof(source2sdk::server::CEffectData, m_hOtherEntity) == 0x3c);
        static_assert(offsetof(source2sdk::server::CEffectData, m_flScale) == 0x40);
        static_assert(offsetof(source2sdk::server::CEffectData, m_flMagnitude) == 0x44);
        static_assert(offsetof(source2sdk::server::CEffectData, m_flRadius) == 0x48);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nSurfaceProp) == 0x4c);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nEffectIndex) == 0x50);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nDamageType) == 0x58);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nPenetrate) == 0x5c);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nMaterial) == 0x5e);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nHitBox) == 0x60);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nColor) == 0x62);
        static_assert(offsetof(source2sdk::server::CEffectData, m_fFlags) == 0x63);
        ...
        static_assert(offsetof(source2sdk::server::CEffectData, m_nExplosionType) == 0x6e);
