...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_fForceAmount; // 0x1f0            
            ...
            source2sdk::particleslib::CParticleTransformInput m_TransformInput; // 0x368            
            // metadata: MPropertyFriendlyName "Min Pullforce"
            source2sdk::particleslib::CPerParticleFloatInput m_fForceAmountMin; // 0x3d0            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_AttractToControlPoint) == 0x548);
    };
};
