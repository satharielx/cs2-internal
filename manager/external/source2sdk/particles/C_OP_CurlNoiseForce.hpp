...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleDirectionNoiseType_t m_nNoiseType; // 0x1e0            
            uint8_t _pad01e4[0x4]; // 0x1e4
            // metadata: MPropertyFriendlyName "noise frequency"
            // metadata: MVectorIsCoordinate
            source2sdk::particleslib::CPerParticleVecInput m_vecNoiseFreq; // 0x1e8            
            // metadata: MPropertyFriendlyName "noise amplitude"
            // metadata: MVectorIsCoordinate
            source2sdk::particleslib::CPerParticleVecInput m_vecNoiseScale; // 0x8a0            
            // metadata: MPropertyFriendlyName "offset"
            // metadata: MVectorIsCoordinate
            source2sdk::particleslib::CPerParticleVecInput m_vecOffset; // 0xf58            
            // metadata: MPropertyFriendlyName "offset rate"
            // metadata: MVectorIsCoordinate
            source2sdk::particleslib::CPerParticleVecInput m_vecOffsetRate; // 0x1610            
            // metadata: MPropertyFriendlyName "worley seed"
            source2sdk::particleslib::CPerParticleFloatInput m_flWorleySeed; // 0x1cc8            
            // metadata: MPropertyFriendlyName "worley jitter"
            source2sdk::particleslib::CPerParticleFloatInput m_flWorleyJitter; // 0x1e38            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_CurlNoiseForce because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_CurlNoiseForce) == 0x1fa8);
    };
};
