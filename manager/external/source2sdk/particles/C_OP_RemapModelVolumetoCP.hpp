...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::BBoxVolumeType_t m_nBBoxType; // 0x1d8            
            // metadata: MPropertyFriendlyName "input control point"
            std::int32_t m_nInControlPointNumber; // 0x1dc            
            ...
            std::int32_t m_nOutControlPointMaxNumber; // 0x1e4            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RemapModelVolumetoCP) == 0x200);
    };
};
