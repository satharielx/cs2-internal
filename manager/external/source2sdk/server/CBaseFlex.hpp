...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_flexWeight[0x18]; // 0xa20            
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "coord"
            VectorWS m_vLookTargetPosition; // 0xa38            
            uint8_t _pad0a44[0x54]; // 0xa44
            source2sdk::entity2::GameTime_t m_flAllowResponsesEndTime; // 0xa98            
            source2sdk::entity2::GameTime_t m_flLastFlexAnimationTime; // 0xa9c            
            source2sdk::client::SceneEventId_t m_nNextSceneEventId; // 0xaa0            
            // metadata: MNotSaved
            bool m_bUpdateLayerPriorities; // 0xaa4            
            uint8_t _pad0aa5[0xb];
        ...
        static_assert(sizeof(source2sdk::server::CBaseFlex) == 0xab0);
    };
};
