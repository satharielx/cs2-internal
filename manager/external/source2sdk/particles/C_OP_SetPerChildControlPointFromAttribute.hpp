...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nParticleIncrement; // 0x1dc            
            // metadata: MPropertyFriendlyName "first particle to copy"
            std::int32_t m_nFirstSourcePoint; // 0x1e0            
