...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_Entity_hCubemapTexture[0x8]; // 0x688            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nHandshake; // 0x6b4            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nEnvCubeMapArrayIndex; // 0x6b8            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nPriority; // 0x6bc            
            // metadata: MNetworkEnable
