...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTick_t m_nNextPrimaryAttackTick; // 0xde0            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalWeaponExclusive"
            float m_flNextPrimaryAttackTickRatio; // 0xde4            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalWeaponExclusive"
            source2sdk::entity2::GameTick_t m_nNextSecondaryAttackTick; // 0xde8            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalWeaponExclusive"
            ...
            std::int32_t m_iClip1; // 0xdf0            
            // metadata: MNetworkEnable
            // metadata: MNetworkSerializer "minusone"
            // metadata: MNetworkUserGroup "LocalWeaponExclusive"
            std::int32_t m_iClip2; // 0xdf4            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalWeaponExclusive"
            std::int32_t m_pReserveAmmo[2]; // 0xdf8            
            source2sdk::entity2::CEntityIOOutput m_OnPlayerUse; // 0xe00            
        ...
        static_assert(sizeof(source2sdk::server::CBasePlayerWeapon) == 0xe20);
    };
};
