...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nRadiusField; // 0x230            
            ...
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nFrequencyField; // 0x238            
            // metadata: MPropertyFriendlyName "amplitude field"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nAmplitudeField; // 0x23c            
            // metadata: MPropertyFriendlyName "control point of shake recipient (-1 = global)"
            std::int32_t m_nFilterCP; // 0x240            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RenderScreenShake) == 0x248);
    };
};
