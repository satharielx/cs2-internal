...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleTraceSet_t m_nTraceSet; // 0x258            
            ...
            std::int32_t m_nControlPointNumber; // 0x274            
