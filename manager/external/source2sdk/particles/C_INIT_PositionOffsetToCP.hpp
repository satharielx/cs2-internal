...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nControlPointNumberStart; // 0x1d8            
            // metadata: MPropertyFriendlyName "offset control point number"
            std::int32_t m_nControlPointNumberEnd; // 0x1dc            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_PositionOffsetToCP) == 0x1e8);
    };
};
