...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnArrivedAt; // 0x4a8            
            source2sdk::server::RotatorTargetSpace_t m_eSpace; // 0x4c0            
        ...
        static_assert(sizeof(source2sdk::server::CRotatorTarget) == 0x4c8);
    };
};
