...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_fFireTime; // 0x1f70            
            std::int32_t m_nLastAttackTick; // 0x1f74            
            uint8_t _pad1f78[0x8];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_WeaponTaser because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_WeaponTaser) == 0x1f80);
    };
};
