...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::CParticleVisibilityInputs VisibilityInputs; // 0x1d0            
