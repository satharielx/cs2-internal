...
namespace source2sdk
{
    namespace particles
    {
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_ControlPointToRadialScreenSpace) == 0x1f8);
    };
};
