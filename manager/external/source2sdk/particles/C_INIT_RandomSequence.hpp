...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            char m_WeightedList[0x18]; // 0x1e8            
            uint8_t _pad0200[0x8];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_RandomSequence because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_RandomSequence) == 0x208);
    };
};
