...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleTransformInput m_TransformInput; // 0x210            
            // metadata: MPropertyFriendlyName "local space transform"
            // metadata: MParticleInputOptional
            source2sdk::particleslib::CParticleTransformInput m_LocalSpaceTransform; // 0x278            
            ...
            source2sdk::particles::ParticleSetMethod_t m_nSetMethod; // 0x2e8            
