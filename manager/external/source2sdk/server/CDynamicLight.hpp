...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::uint8_t m_ActualFlags; // 0x730            
            // metadata: MNetworkEnable
            std::uint8_t m_Flags; // 0x731            
            // metadata: MNetworkEnable
            std::uint8_t m_LightStyle; // 0x732            
            bool m_On; // 0x733            
            // metadata: MNetworkEnable
            float m_Radius; // 0x734            
            // metadata: MNetworkEnable
            std::int32_t m_Exponent; // 0x738            
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::server::CDynamicLight) == 0x748);
    };
};
