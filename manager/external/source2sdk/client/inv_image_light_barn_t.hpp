...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::inv_image_light_barn_t, color) == 0x0);
        static_assert(offsetof(source2sdk::client::inv_image_light_barn_t, angle) == 0xc);
        static_assert(offsetof(source2sdk::client::inv_image_light_barn_t, brightness) == 0x18);
        static_assert(offsetof(source2sdk::client::inv_image_light_barn_t, orbit_distance) == 0x1c);
        
        static_assert(sizeof(source2sdk::client::inv_image_light_barn_t) == 0x20);
    };
};
