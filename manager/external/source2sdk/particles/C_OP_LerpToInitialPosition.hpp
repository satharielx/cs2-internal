...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nCacheField; // 0x348            
            uint8_t _pad034c[0x4]; // 0x34c
            // metadata: MPropertyFriendlyName "scale"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flScale; // 0x350            
            // metadata: MPropertyFriendlyName "component scale"
            source2sdk::particleslib::CParticleCollectionVecInput m_vecScale; // 0x4c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_LerpToInitialPosition because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_LerpToInitialPosition) == 0xb78);
    };
};
