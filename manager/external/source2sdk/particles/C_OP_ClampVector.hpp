...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleVecInput m_vecOutputMin; // 0x1d8            
            // metadata: MPropertyFriendlyName "output maximum"
            // metadata: MVectorIsSometimesCoordinate "m_nFieldOutput"
            source2sdk::particleslib::CPerParticleVecInput m_vecOutputMax; // 0x890            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_ClampVector because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_ClampVector) == 0xf48);
    };
};
