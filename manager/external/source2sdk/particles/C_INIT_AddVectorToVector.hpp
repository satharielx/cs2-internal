...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            // metadata: MPropertyAttributeChoiceName "particlefield_vector"
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldInput; // 0x1e8            
            ...
            source2sdk::particles::CRandomNumberGeneratorParameters m_randomnessParameters; // 0x204            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_AddVectorToVector) == 0x210);
    };
};
