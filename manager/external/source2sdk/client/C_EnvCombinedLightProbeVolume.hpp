...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_Entity_hCubemapTexture[0x8]; // 0x1688            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_AmbientCube[0x8]; // 0x1698            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SDF[0x8]; // 0x16a0            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SH2_DC[0x8]; // 0x16a8            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SH2_R[0x8]; // 0x16b0            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SH2_G[0x8]; // 0x16b8            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SH2_B[0x8]; // 0x16c0            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeDirectLightIndicesTexture[0x8]; // 0x16c8            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeDirectLightScalarsTexture[0x8]; // 0x16d0            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeDirectLightShadowsTexture[0x8]; // 0x16d8            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nHandshake; // 0x16fc            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nEnvCubeMapArrayIndex; // 0x1700            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nPriority; // 0x1704            
            // metadata: MNetworkEnable
            bool m_Entity_bStartDisabled; // 0x1708            
            uint8_t _pad1709[0x3]; // 0x1709
            // metadata: MNetworkEnable
            float m_Entity_flEdgeFadeDist; // 0x170c            
            // metadata: MNetworkEnable
            Vector m_Entity_vEdgeFadeDists; // 0x1710            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeX; // 0x171c            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeY; // 0x1720            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeZ; // 0x1724            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasX; // 0x1728            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasY; // 0x172c            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasZ; // 0x1730            
            uint8_t _pad1734[0x15]; // 0x1734
            // metadata: MNetworkEnable
            bool m_Entity_bEnabled; // 0x1749            
            uint8_t _pad174a[0x6];
            
            // Datamap fields:
            // void m_Entity_pEnvMap; // 0x1738
            // void m_Entity_pLightProbeVolume; // 0x1740
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_EnvCombinedLightProbeVolume because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_EnvCombinedLightProbeVolume) == 0x1750);
    };
};
