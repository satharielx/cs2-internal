...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nHardwareType; // 0xc80            
            bool m_bNeedsHardware; // 0xc84            
            uint8_t _pad0c85[0x3]; // 0xc85
            ...
            source2sdk::server::locksound_t m_ls; // 0xcb0            
            ...
            source2sdk::entity2::CEntityIOOutput m_OnBlockedOpening; // 0xd70            
            source2sdk::entity2::CEntityIOOutput m_OnUnblockedClosing; // 0xd88            
            source2sdk::entity2::CEntityIOOutput m_OnUnblockedOpening; // 0xda0            
            source2sdk::entity2::CEntityIOOutput m_OnFullyClosed; // 0xdb8            
            source2sdk::entity2::CEntityIOOutput m_OnFullyOpen; // 0xdd0            
            source2sdk::entity2::CEntityIOOutput m_OnClose; // 0xde8            
            source2sdk::entity2::CEntityIOOutput m_OnOpen; // 0xe00            
            source2sdk::entity2::CEntityIOOutput m_OnLockedUse; // 0xe18            
            source2sdk::entity2::CEntityIOOutput m_OnAjarOpen; // 0xe30            
            uint8_t _pad0e48[0x8];
        ...
        static_assert(sizeof(source2sdk::server::CBasePropDoor) == 0xe50);
    };
};
