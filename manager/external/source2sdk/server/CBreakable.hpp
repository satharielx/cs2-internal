...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CPropDataComponent m_CPropDataComponent; // 0x738            
            source2sdk::server::Materials m_Material; // 0x778            
            ...
            char m_hBreaker[0x4]; // 0x77c            
            source2sdk::server::Explosions m_Explosion; // 0x780            
            uint8_t _pad0784[0x4]; // 0x784
            CUtlSymbolLarge m_iszSpawnObject; // 0x788            
            float m_flPressureDelay; // 0x790            
            std::int32_t m_iMinHealthDmg; // 0x794            
            CUtlSymbolLarge m_iszPropData; // 0x798            
            float m_impactEnergyScale; // 0x7a0            
            source2sdk::server::EOverrideBlockLOS_t m_nOverrideBlockLOS; // 0x7a4            
            source2sdk::entity2::CEntityIOOutput m_OnStartDeath; // 0x7a8            
            source2sdk::entity2::CEntityIOOutput m_OnBreak; // 0x7c0            
            // m_OnHealthChanged has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEntityOutputTemplate<float,float> m_OnHealthChanged;
            char m_OnHealthChanged[0x20]; // 0x7d8            
            source2sdk::client::PerformanceMode_t m_PerformanceMode; // 0x7f8            
            // m_hPhysicsAttacker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBasePlayerPawn> m_hPhysicsAttacker;
            char m_hPhysicsAttacker[0x4]; // 0x7fc            
            source2sdk::entity2::GameTime_t m_flLastPhysicsInfluenceTime; // 0x800            
        ...
        static_assert(sizeof(source2sdk::server::CBreakable) == 0x808);
    };
};
