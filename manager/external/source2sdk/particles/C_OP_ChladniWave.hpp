...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleVecInput m_vecWaveLength; // 0x798            
            // metadata: MPropertyFriendlyName "harmonics"
            source2sdk::particleslib::CPerParticleVecInput m_vecHarmonics; // 0xe50            
            ...
            std::int32_t m_nLocalSpaceControlPoint; // 0x150c            
            // metadata: MPropertyFriendlyName "3D"
            bool m_b3D; // 0x1510            
            uint8_t _pad1511[0x7];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_ChladniWave because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_ChladniWave) == 0x1518);
    };
};
