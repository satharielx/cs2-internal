...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSkyMaterialLightingOnly[0x8]; // 0x738            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "SkyStateChanged"
