...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nAlphaMin; // 0x1dc            
            // metadata: MPropertyFriendlyName "alpha max"
            // metadata: MPropertyAttributeRange "0 255"
            std::int32_t m_nAlphaMax; // 0x1e0            
            uint8_t _pad01e4[0x8]; // 0x1e4
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_RandomAlpha) == 0x1f0);
    };
};
