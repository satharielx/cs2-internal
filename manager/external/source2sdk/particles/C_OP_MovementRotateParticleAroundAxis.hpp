...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionVecInput m_vecRotAxis; // 0x1d0            
            // metadata: MPropertyFriendlyName "rotation rate"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flRotRate; // 0x888            
            // metadata: MPropertyFriendlyName "transform input"
            source2sdk::particleslib::CParticleTransformInput m_TransformInput; // 0x9f8            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_MovementRotateParticleAroundAxis) == 0xa68);
    };
};
