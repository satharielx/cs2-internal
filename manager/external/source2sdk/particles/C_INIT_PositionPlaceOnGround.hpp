...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_flMaxTraceLength; // 0x348            
            // metadata: MPropertyFriendlyName "collision group"
            char m_CollisionGroupName[128]; // 0x4b8            
            // metadata: MPropertyFriendlyName "Trace Set"
            source2sdk::particles::ParticleTraceSet_t m_nTraceSet; // 0x538            
            uint8_t _pad053c[0xc]; // 0x53c
            // metadata: MPropertyFriendlyName "No Collision Behavior"
            source2sdk::particles::ParticleTraceMissBehavior_t m_nTraceMissBehavior; // 0x548            
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nAttribute; // 0x550            
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nTraceDirectionAttribute; // 0x558            
            ...
            std::int32_t m_nPreserveOffsetCP; // 0x564            
            // metadata: MPropertyFriendlyName "CP Entity to Ignore for Collisions"
            // metadata: MPropertySuppressExpr "m_nTraceSet == PARTICLE_TRACE_SET_STATIC"
            std::int32_t m_nIgnoreCP; // 0x568            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_PositionPlaceOnGround) == 0x570);
    };
};
