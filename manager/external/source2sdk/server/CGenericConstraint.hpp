...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::physicslib::JointMotion_t m_nLinearMotionX; // 0x510            
            source2sdk::physicslib::JointMotion_t m_nLinearMotionY; // 0x514            
            source2sdk::physicslib::JointMotion_t m_nLinearMotionZ; // 0x518            
            ...
            source2sdk::entity2::GameTime_t m_flBreakAfterTimeStartTimeX; // 0x54c            
            source2sdk::entity2::GameTime_t m_flBreakAfterTimeStartTimeY; // 0x550            
            source2sdk::entity2::GameTime_t m_flBreakAfterTimeStartTimeZ; // 0x554            
            ...
            source2sdk::entity2::GameTime_t m_flNotifyForceLastTimeX; // 0x57c            
            source2sdk::entity2::GameTime_t m_flNotifyForceLastTimeY; // 0x580            
            source2sdk::entity2::GameTime_t m_flNotifyForceLastTimeZ; // 0x584            
            bool m_bAxisNotifiedX; // 0x588            
            bool m_bAxisNotifiedY; // 0x589            
            bool m_bAxisNotifiedZ; // 0x58a            
            uint8_t _pad058b[0x1]; // 0x58b
            source2sdk::physicslib::JointMotion_t m_nAngularMotionX; // 0x58c            
            source2sdk::physicslib::JointMotion_t m_nAngularMotionY; // 0x590            
            source2sdk::physicslib::JointMotion_t m_nAngularMotionZ; // 0x594            
