...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldInput1; // 0x1dc            
            // metadata: MPropertyFriendlyName "input scale 1"
            float m_flInputScale1; // 0x1e0            
            // metadata: MPropertyFriendlyName "input field 2"
            // metadata: MPropertyAttributeChoiceName "particlefield_vector"
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldInput2; // 0x1e4            
            ...
            source2sdk::particles::ControlPointReference_t m_nControlPointInput1; // 0x1ec            
            ...
            source2sdk::particles::ControlPointReference_t m_nControlPointInput2; // 0x204            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_CalculateVectorAttribute) == 0x230);
    };
};
