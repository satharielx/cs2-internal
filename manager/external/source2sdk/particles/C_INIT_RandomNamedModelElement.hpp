...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            uint8_t _pad01fb[0x1]; // 0x1fb
            // metadata: MPropertyFriendlyName "output field"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldOutput; // 0x1fc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_RandomNamedModelElement because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_RandomNamedModelElement) == 0x200);
    };
};
