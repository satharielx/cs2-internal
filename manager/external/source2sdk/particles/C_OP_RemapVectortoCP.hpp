...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldInput; // 0x1d4            
            // metadata: MPropertyFriendlyName "particle number to read"
            std::int32_t m_nParticleNumber; // 0x1d8            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RemapVectortoCP) == 0x1e0);
    };
};
