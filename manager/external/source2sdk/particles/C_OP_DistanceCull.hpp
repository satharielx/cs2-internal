...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            uint8_t _pad0351[0x3]; // 0x351
            // metadata: MPropertyFriendlyName "Attribute to Test"
            // metadata: MPropertyAttributeChoiceName "particlefield_vector"
            source2sdk::particles::ParticleAttributeIndex_t m_nAttribute; // 0x354            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_DistanceCull because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_DistanceCull) == 0x358);
    };
};
